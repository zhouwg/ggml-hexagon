...
- <b>PP performance has reached parity with Qualcomm's official ggml-hexagon backend.</b> On Snapdragon 8 Elite (OnePlus 13, v79) with gemma-4-E2B-it-Q4_0, JZ PP peak hit 378 tok/s, matching Qualcomm's peak of ~380 tok/s - a 3.6x improvement from the 2026-07-05 baseline (JZ PP=105.6 vs QCOM PP=217.8, when Qualcomm was 2.06x faster). TG still trails Qualcomm (~19.8 vs ~27.3 tok/s) because JZ uses synchronous FastRPC with no batch-level pipelining, while Qualcomm's dspqueue overlaps AP preparation with DSP execution (up to 16 batches in flight); the per-subgraph sync overhead accumulates across ~17 subgraphs x 255 tokens. Full analysis at [warmup-ab-test-and-analysis-20260713.md](docs/backend/jz-ggml-hexagon/warmup-ab-test-and-analysis-20260713.md) and [ion-mempool-vs-perbuffer-analysis-20260713.md](docs/backend/jz-ggml-hexagon/ion-mempool-vs-perbuffer-analysis-20260713.md). AI experts and domain tech experts' help/effort based on branch self-build-jz is greatly welcomed.
