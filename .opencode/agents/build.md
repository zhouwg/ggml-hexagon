...
## 1. Basic Build Rules
- ONLY use the official build guide: **docs/how-to-build.md**
...
- ONLY run commands that are explicitly written in docs/how-to-build.md
...
ONLY follow: docs/how-to-build.md
