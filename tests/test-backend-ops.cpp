...
#ifdef GGML_USE_HEXAGON
    printf("Usage: %s [mode] [-i <hexagon_backend_index> -a mulmat_algotype] [-o <op,..>] [-b <backend>] [-p <params regex>] [--output <console|sql|csv>] [--list-ops]", argv[0]);
#else
...
#ifdef GGML_USE_HEXAGON
    printf("    -i <n> hexagon_backend_index:  0 -- QNN_CPU, 1  -- QNN_GPU,          2 -- QNN_NPU, 3 -- cDSP, 4 -- ggml-cpu)\n");
