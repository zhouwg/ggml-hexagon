...
this self-contained file is part of JZ's ggml-hexagon:
    - a customized tiny ggml running on Qualcomm Hexagon NPU(aka HTP, cDSP)
...
#include "ggml-dsp.h"
#include "../htp/hvx-base.h"   // for hvx_vec_splat_f32/f16, hvx_vec_store_u/a, hvx_vec_f32_to_f16, etc.

void ggml_log_internal(int level, const char *file, const char *func, int line, const char *format, ...) {
...
void ggml_dump_tensor_elements(const ggml_tensor * tensor) {
#if !GGMLHEXAGON_DEBUG
    return;
#endif
    float value = 0;
...
void ggml_dump_tensor(const ggml_tensor * tensor, int dump_tensor_data) {
    ...
    if ((1 == dump_tensor_data) && (ggml_nbytes(tensor) < 320)) {
        ggml_dump_tensor_elements(tensor);
    }
}
...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_F32] = {
        ...
        .vec_dot_ref              = vec_dot_f32_generic,
    },
    [GGML_TYPE_F16] = {
        .type_name                = "f16",
        .blck_size                = 1,
        ...
        .is_quantized             = false,
        .to_float_ref             = (ggml_to_float_t) ggml_fp16_to_fp32_row,
        .from_float_ref           = (ggml_from_float_t) ggml_fp32_to_fp16_row,
        .vec_dot_type             = GGML_TYPE_F16,
        .vec_dot_ref              = vec_dot_f16_f16_generic,
    },
    [GGML_TYPE_Q1_0] = {
        .type_name                = "q1_0",
        .blck_size                = QK1_0,
        ...
        .is_quantized             = true,
        .to_float_ref             = (ggml_to_float_t) dequantize_row_q1_0,
    ...
    [GGML_TYPE_Q4_0] = {
        ...
        .is_quantized             = true,
        .to_float_ref             = (ggml_to_float_t) dequantize_row_q4_0,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q4_0_ref,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .vec_dot_ref              = vec_dot_q4_0_q8_0_generic,
    },
    [GGML_TYPE_Q4_1] = {
        .type_name                = "q4_1",
        .blck_size                = QK4_1,
        ...
        .is_quantized             = true,
        .to_float_ref             = (ggml_to_float_t) dequantize_row_q4_1,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q4_1_ref,
        .vec_dot_type             = GGML_TYPE_Q8_1,
        .vec_dot_ref              = vec_dot_q4_1_q8_1_generic,
    },
    [4] = { // GGML_TYPE_Q4_2
    ...
    [GGML_TYPE_Q5_0] = {
        ...
        .is_quantized             = true,
        .to_float_ref             = (ggml_to_float_t) dequantize_row_q5_0,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q5_0_ref,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .vec_dot_ref              = vec_dot_q5_0_q8_0_generic,
    },
    [GGML_TYPE_Q5_1] = {
        .type_name                = "q5_1",
        .blck_size                = QK5_1,
        ...
        .is_quantized             = true,
        .to_float_ref             = (ggml_to_float_t) dequantize_row_q5_1,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q5_1_ref,
        .vec_dot_type             = GGML_TYPE_Q8_1,
        .vec_dot_ref              = vec_dot_q5_1_q8_1_generic,
    },
    [GGML_TYPE_Q8_0] = {
        .type_name                = "q8_0",
        .blck_size                = QK8_0,
        ...
        .is_quantized             = true,
        .to_float_ref             = (ggml_to_float_t) dequantize_row_q8_0,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q8_0_ref,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .vec_dot_ref              = vec_dot_q8_0_q8_0_generic,
    },
    [GGML_TYPE_Q8_1] = {
        .type_name                = "q8_1",
        .blck_size                = QK8_1,
    ...
    [GGML_TYPE_MXFP4] = {
        ...
        .is_quantized             = true,
        .to_float_ref             = (ggml_to_float_t) dequantize_row_mxfp4,
        .from_float_ref           = (ggml_from_float_t)quantize_row_mxfp4_ref,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .vec_dot_ref              = vec_dot_mxfp4_q8_0_generic,
    },
    [GGML_TYPE_NVFP4] = {
        .type_name                = "nvfp4",
        .blck_size                = QK_NVFP4,
        ...
        .is_quantized             = true,
        .to_float_ref             = (ggml_to_float_t) dequantize_row_nvfp4,
        .from_float_ref           = (ggml_from_float_t)quantize_row_nvfp4_ref,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .vec_dot_ref              = vec_dot_nvfp4_q8_0_generic,
    },
    [GGML_TYPE_Q2_K] = {
        .type_name                = "q2_K",
        .blck_size                = QK_K,
        ...
        .is_quantized             = true,
        .to_float_ref             = (ggml_to_float_t) dequantize_row_q2_K,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q2_K_ref,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .vec_dot_ref              = vec_dot_q2_K_q8_K_generic,
    },
    [GGML_TYPE_Q3_K] = {
        .type_name                = "q3_K",
        .blck_size                = QK_K,
        ...
        .is_quantized             = true,
        .to_float_ref             = (ggml_to_float_t) dequantize_row_q3_K,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q3_K_ref,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .vec_dot_ref              = vec_dot_q3_K_q8_K_generic,
    },
    [GGML_TYPE_Q4_K] = {
        .type_name                = "q4_K",
        .blck_size                = QK_K,
        ...
        .is_quantized             = true,
        .to_float_ref             = (ggml_to_float_t) dequantize_row_q4_K,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q4_K_ref,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .vec_dot_ref              = vec_dot_q4_K_q8_K_generic,
    },
    [GGML_TYPE_Q5_K] = {
        .type_name                = "q5_K",
        .blck_size                = QK_K,
        ...
        .is_quantized             = true,
        .to_float_ref             = (ggml_to_float_t) dequantize_row_q5_K,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q5_K_ref,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .vec_dot_ref              = vec_dot_q5_K_q8_K_generic,
    },
    [GGML_TYPE_Q6_K] = {
        .type_name                = "q6_K",
        .blck_size                = QK_K,
        ...
        .is_quantized             = true,
        .to_float_ref             = (ggml_to_float_t) dequantize_row_q6_K,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q6_K_ref,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .vec_dot_ref              = vec_dot_q6_K_q8_K_generic,
    },
    [GGML_TYPE_IQ2_XXS] = {
        .type_name                = "iq2_xxs",
        .blck_size                = QK_K,
        ...
        .is_quantized             = true,
        .to_float_ref             = (ggml_to_float_t) dequantize_row_iq2_xxs,
        .from_float_ref           = NULL,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .vec_dot_ref              = vec_dot_iq2_xxs_q8_K_generic,
    },
    [GGML_TYPE_IQ2_XS] = {
        .type_name                = "iq2_xs",
        .blck_size                = QK_K,
        ...
        .is_quantized             = true,
        .to_float_ref             = (ggml_to_float_t) dequantize_row_iq2_xs,
        .from_float_ref           = NULL,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .vec_dot_ref              = vec_dot_iq2_xs_q8_K_generic,
    },
    [GGML_TYPE_IQ3_XXS] = {
        .type_name                = "iq3_xxs",
        .blck_size                = QK_K,
        ...
        .is_quantized             = true,
        .to_float_ref             = (ggml_to_float_t) dequantize_row_iq3_xxs,
        .from_float_ref           = (ggml_from_float_t)quantize_row_iq3_xxs_ref,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .vec_dot_ref              = vec_dot_iq3_xxs_q8_K_generic,
    },
    [GGML_TYPE_IQ3_S] = {
        .type_name                = "iq3_s",
        .blck_size                = QK_K,
        ...
        .is_quantized             = true,
        .to_float_ref             = (ggml_to_float_t) dequantize_row_iq3_s,
    ...
    [GGML_TYPE_IQ2_S] = {
        ...
        .is_quantized             = true,
        .to_float_ref             = (ggml_to_float_t) dequantize_row_iq2_s,
        .from_float_ref           = (ggml_from_float_t)quantize_row_iq2_s_ref,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .vec_dot_ref              = vec_dot_iq2_s_q8_K_generic,
    },
    [GGML_TYPE_IQ1_S] = {
        .type_name                = "iq1_s",
        .blck_size                = QK_K,
        ...
        .is_quantized             = true,
        .to_float_ref             = (ggml_to_float_t) dequantize_row_iq1_s,
        .from_float_ref           = NULL,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .vec_dot_ref              = vec_dot_iq1_s_q8_K_generic,
    },
    [GGML_TYPE_IQ1_M] = {
        .type_name                = "iq1_m",
        .blck_size                = QK_K,
        ...
        .is_quantized             = true,
        .to_float_ref             = (ggml_to_float_t) dequantize_row_iq1_m,
        .from_float_ref           = NULL,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .vec_dot_ref              = NULL,
    },
    [GGML_TYPE_IQ4_NL] = {
        ...
        .is_quantized             = true,
        .to_float_ref             = (ggml_to_float_t) dequantize_row_iq4_nl,
        .from_float_ref           = (ggml_from_float_t)quantize_row_iq4_nl_ref,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .vec_dot_ref              = vec_dot_iq4_nl_q8_0_generic,
    },
    [GGML_TYPE_IQ4_XS] = {
        .type_name                = "iq4_xs",
        .blck_size                = QK_K,
        ...
        .is_quantized             = true,
        .to_float_ref             = (ggml_to_float_t) dequantize_row_iq4_xs,
        .from_float_ref           = (ggml_from_float_t)quantize_row_iq4_xs_ref,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .vec_dot_ref              = vec_dot_iq4_xs_q8_K_generic,
    },
    [GGML_TYPE_Q8_K] = {
        .type_name                = "q8_K",
        .blck_size                = QK_K,
    ...
    [GGML_TYPE_BF16] = {
        ...
        .is_quantized             = false,
        .to_float_ref             = (ggml_to_float_t) ggml_bf16_to_fp32_row,
        .from_float_ref           = (ggml_from_float_t) ggml_fp32_to_bf16_row_ref,
        .vec_dot_type             = GGML_TYPE_BF16,
        .vec_dot_ref              = vec_dot_bf16_bf16_generic,
    },
    ...
    [GGML_TYPE_TQ1_0] = {
        ...
        .is_quantized             = true,
        .to_float_ref             = (ggml_to_float_t) dequantize_row_tq1_0,
    ...
    [GGML_TYPE_TQ2_0] = {
        ...
        .is_quantized             = true,
        .to_float_ref             = (ggml_to_float_t) dequantize_row_tq2_0,
...
static const struct ggml_type_traits_dsp type_traits_generic[GGML_TYPE_COUNT] = {
    [GGML_TYPE_F32] = {
        .from_float       = NULL,
        .to_float         = NULL,
        .vec_dot          = vec_dot_f32_generic,
        .vec_dot_type     = GGML_TYPE_F32,
        .nrows            = 1,
    },
    [GGML_TYPE_F16] = {
        .from_float       = (ggml_from_float_t) quantize_row_f32_to_f16_ref,
        .to_float         = NULL,
    ...
    [GGML_TYPE_Q4_0] = {
        .from_float       = (ggml_from_float_t) quantize_row_q8_0_ref,
        .to_float         = NULL,
    ...
    [GGML_TYPE_Q4_1] = {
        .from_float       = (ggml_from_float_t) quantize_row_q8_1_ref,
        .to_float         = NULL,
    ...
    [GGML_TYPE_BF16] = {
        ...
        .to_float         = NULL,
        .vec_dot          = vec_dot_bf16_bf16_generic,
        .vec_dot_type     = GGML_TYPE_BF16,
        .nrows            = 1,
    },
    [GGML_TYPE_Q2_K] = {
        .from_float       = (ggml_from_float_t) quantize_row_q8_K_ref,
        .to_float         = NULL,
        .vec_dot          = vec_dot_q2_K_q8_K_generic,
        .vec_dot_type     = GGML_TYPE_Q8_K,
        .nrows            = 1,
    },
    [GGML_TYPE_Q3_K] = {
        .from_float       = (ggml_from_float_t) quantize_row_q8_K_ref,
        .to_float         = NULL,
        .vec_dot          = vec_dot_q3_K_q8_K_generic,
        .vec_dot_type     = GGML_TYPE_Q8_K,
        .nrows            = 1,
    },
    [GGML_TYPE_Q4_K] = {
        .from_float       = (ggml_from_float_t) quantize_row_q8_K_ref,
        .to_float         = NULL,
        .vec_dot          = vec_dot_q4_K_q8_K_generic,
        .vec_dot_type     = GGML_TYPE_Q8_K,
        .nrows            = 1,
    },
    [GGML_TYPE_Q5_K] = {
        .from_float       = (ggml_from_float_t) quantize_row_q8_K_ref,
        .to_float         = NULL,
        .vec_dot          = vec_dot_q5_K_q8_K_generic,
        .vec_dot_type     = GGML_TYPE_Q8_K,
        .nrows            = 1,
    },
    [GGML_TYPE_Q6_K] = {
        .from_float       = (ggml_from_float_t) quantize_row_q8_K_ref,
        .to_float         = NULL,
        .vec_dot          = vec_dot_q6_K_q8_K_generic,
        .vec_dot_type     = GGML_TYPE_Q8_K,
        .nrows            = 1,
    },
    [GGML_TYPE_MXFP4] = {
    ...
    [GGML_TYPE_NVFP4] = {
        .from_float       = (ggml_from_float_t) quantize_row_q8_0_ref,
        .to_float         = NULL,
        .vec_dot          = vec_dot_nvfp4_q8_0_generic,
        .vec_dot_type     = GGML_TYPE_Q8_0,
        .nrows            = 1,
    },
    [GGML_TYPE_IQ2_XXS] = {
        .from_float       = (ggml_from_float_t) quantize_row_q8_K_ref,
        .to_float         = NULL,
        .vec_dot          = vec_dot_iq2_xxs_q8_K_generic,
        .vec_dot_type     = GGML_TYPE_Q8_K,
        .nrows            = 1,
    },
    [GGML_TYPE_IQ2_XS] = {
        .from_float       = (ggml_from_float_t) quantize_row_q8_K_ref,
        .to_float         = NULL,
        .vec_dot          = vec_dot_iq2_xs_q8_K_generic,
        .vec_dot_type     = GGML_TYPE_Q8_K,
        .nrows            = 1,
    },
    [GGML_TYPE_IQ2_S] = {
        .from_float       = (ggml_from_float_t) quantize_row_q8_K_ref,
        .to_float         = NULL,
        .vec_dot          = vec_dot_iq2_s_q8_K_generic,
        .vec_dot_type     = GGML_TYPE_Q8_K,
        .nrows            = 1,
    },
    [GGML_TYPE_IQ3_XXS] = {
        .from_float       = (ggml_from_float_t) quantize_row_q8_K_ref,
        .to_float         = NULL,
        .vec_dot          = vec_dot_iq3_xxs_q8_K_generic,
        .vec_dot_type     = GGML_TYPE_Q8_K,
        .nrows            = 1,
    },
    [GGML_TYPE_IQ1_S] = {
        .from_float       = (ggml_from_float_t) quantize_row_q8_K_ref,
        .to_float         = NULL,
        .vec_dot          = vec_dot_iq1_s_q8_K_generic,
        .vec_dot_type     = GGML_TYPE_Q8_K,
        .nrows            = 1,
    },
    [GGML_TYPE_IQ4_XS] = {
        .from_float       = (ggml_from_float_t) quantize_row_q8_K_ref,
        .to_float         = NULL,
        .vec_dot          = vec_dot_iq4_xs_q8_K_generic,
        .vec_dot_type     = GGML_TYPE_Q8_K,
        .nrows            = 1,
    },
    [GGML_TYPE_Q8_K] = {
...
// DSP-optimized traits table - HVX-accelerated function pointers go here
static const struct ggml_type_traits_dsp type_traits_dsp[GGML_TYPE_COUNT] = {
    [GGML_TYPE_F32] = {
        .from_float       = NULL,
        .to_float         = NULL,
        .vec_dot          = vec_dot_f32_hvx,
        .vec_dot_type     = GGML_TYPE_F32,
        .nrows            = 1,
    },
    [GGML_TYPE_F16] = {
    ...
    [GGML_TYPE_BF16] = {
        .from_float       = (ggml_from_float_t) quantize_row_bf16_hvx,
        .to_float         = NULL,
        .vec_dot          = vec_dot_bf16_bf16_generic,
        .vec_dot_type     = GGML_TYPE_BF16,
        .nrows            = 1,
    ...
    [GGML_TYPE_Q2_K] = {
        .from_float       = (ggml_from_float_t) quantize_row_q8_K_hvx,
        .to_float         = NULL,
        .vec_dot          = vec_dot_q2_K_q8_K_generic,
        .vec_dot_type     = GGML_TYPE_Q8_K,
        .nrows            = 1,
...
static int ggml_dsp_use_hvx = 0; // 0 = generic, 1 = HVX-optimized

void ggml_type_traits_dsp_init(int use_hvx) {
...
const struct ggml_type_traits_dsp * ggml_get_type_traits_dsp(enum ggml_type type) {
    assert(type >= 0);
    assert(type < GGML_TYPE_COUNT);
    return ggml_dsp_use_hvx ? &type_traits_dsp[type] : &type_traits_generic[type];
}
...
size_t ggml_get_op_index(const struct ggml_tensor * tensor) {
    return (size_t)tensor->op;
}

void ggml_get_opkey(enum ggml_op op, const struct ggml_tensor * src0, const struct ggml_tensor * src1, char * buf, size_t buf_size) {
    ...
    if (src1 != NULL) {
        const char * src1_type_name = ggml_get_type_traits((enum ggml_type)src1->type)->type_name;
        len = strlen(buf);
        if (len < buf_size) {
...
float ggml_bf16_to_fp32(ggml_bf16_t x) {
    return ggml_compute_bf16_to_fp32(x);
}

ggml_bf16_t ggml_fp32_to_bf16(float x) {
    return ggml_compute_fp32_to_bf16(x);
}
...
void quantize_row_f32_to_f16_ref(const float * GGML_RESTRICT x, uint16_t * GGML_RESTRICT y, int n) {
    for (int i = 0; i < n; ++i) {
        y[i] = ggml_compute_fp32_to_fp16(x[i]);
    }
}
...
static inline HVX_Vector hvx_vec_reduce_max_f32(HVX_Vector in) {
    ...
    while (width < total) {
        ...
        _max   = HVX_VMAX_F32(_max_t, _max);  // elementwise max
        width  = width << 1;
    }
...
static inline HVX_Vector hvx_vec_reduce_min_f32(HVX_Vector in) {
    ...
    while (width < total) {
        ...
        _min   = HVX_VMIN_F32(_min_t, _min);  // elementwise min
        width  = width << 1;
    }
...
static void vec_dot_f32_hvx_impl(int n, float *GGML_RESTRICT s, const float *GGML_RESTRICT x, const float *GGML_RESTRICT y) {
    ...
    #pragma unroll(4)
    for (i = 0; i < nvec; i++) {
        HVX_Vector prod = HVX_VMUL_F32(vx[i], vy[i]);
        rsum = HVX_VADD_F32(rsum, prod);
    }
    ...
    if (nloe) {
        ...
        HVX_Vector prod = HVX_VMUL_F32(x_sf, y_sf);
        rsum = HVX_VADD_F32(rsum, prod);
    }
...
void vec_dot_f16_f16_hvx(int n, float *GGML_RESTRICT s, size_t bs, const void *GGML_RESTRICT vx, size_t bx,
    ...
    if (nvec > 0) {
        ...
        HVX_Vector sum_v = HVX_VADD_F32(acc_lo, acc_hi);
    ...
    for (int i = 0; i < nb; ++i) {
        ...
        if (((uintptr_t)y_ptr & 0x7F) == 0 && QK4_0 >= VLEN_FP32) {
            ...
            for (int j = 0; j < QK4_0 / VLEN_FP32; ++j) {
                HVX_Vector prod = HVX_VMUL_F32(vdq[j], vy[j]);
                rsum = HVX_VADD_F32(rsum, prod);
            }
...
void vec_dot_bf16_bf16_hvx(int n, float *GGML_RESTRICT s, size_t bs, const void *GGML_RESTRICT vx,
    ...
    if (nvec > 0) {
        ...
        for (int i = 0; i < nvec; ++i) {
            ...
            acc0 = HVX_VADD_F32(acc0, HVX_VMUL_F32(vx_lo, vy_lo));
            ...
            acc1 = HVX_VADD_F32(acc1, HVX_VMUL_F32(vx_hi, vy_hi));
        }

        HVX_Vector sum_v = HVX_VADD_F32(acc0, acc1);
        sumf = horizontal_sum_f32(sum_v);
    ...
    for (int i = 0; i < nb; ++i) {
        ...
        if (((uintptr_t)src & 0x7F) == 0) {
            ...
            for (int j = 0; j < QK8_0 / VLEN_FP32; ++j) {
                ...
                vabs_max = HVX_VMAX_F32(vabs_max, vabs);
            }
    ...
    for (int i = 0; i < nb; i++) {
        ...
        if (((uintptr_t)src & 0x7F) == 0) {
            ...
            for (int j = 0; j < QK5_1 / VLEN_FP32; ++j) {
                HVX_Vector v = vsrc[j];
                vmin = HVX_VMIN_F32(vmin, v);
                vmax = HVX_VMAX_F32(vmax, v);
            }
