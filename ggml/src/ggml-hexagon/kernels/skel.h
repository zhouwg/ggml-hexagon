...
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(ggmlop_dsp_execute_batch)(remote_handle64 _h, uint32 batch_offset, uint32 batch_size) __QAIC_HEADER_ATTRIBUTE;
