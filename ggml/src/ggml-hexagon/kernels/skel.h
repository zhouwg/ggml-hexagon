...
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(ggmlop_dsp_setclocks)(remote_handle64 _h, int32 power_level, int32 offload_cgraph_type, int32 mulmat_algotype, int32 thread_counts) __QAIC_HEADER_ATTRIBUTE;
