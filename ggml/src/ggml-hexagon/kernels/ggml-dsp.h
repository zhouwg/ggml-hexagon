...
struct ggml_type_traits {
    ...
    size_t                   type_size;
    bool                     is_quantized;
    ggml_to_float_t          to_float_ref;
    ggml_from_float_t        from_float_ref;
    enum ggml_type           vec_dot_type;
    ggml_vec_dot_t           vec_dot_ref;
};

struct ggml_type_traits_dsp {
...
GGML_API void vec_dot_f32_hvx          (int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT x, size_t bx, const void * GGML_RESTRICT y, size_t by, int nrc);
GGML_API void vec_dot_f16_f16_generic   (int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT x, size_t bx, const void * GGML_RESTRICT y, size_t by, int nrc);
GGML_API void vec_dot_f16_f32_generic   (int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT x, size_t bx, const void * GGML_RESTRICT y, size_t by, int nrc);
GGML_API void vec_dot_q4_0_q8_0_generic (int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT x, size_t bx, const void * GGML_RESTRICT y, size_t by, int nrc);
GGML_API void vec_dot_q4_1_q8_1_generic (int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT x, size_t bx, const void * GGML_RESTRICT y, size_t by, int nrc);
GGML_API void vec_dot_q5_0_q8_0_generic (int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT x, size_t bx, const void * GGML_RESTRICT y, size_t by, int nrc);
...
GGML_API void vec_dot_q3_K_q8_K_generic  (int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT x, size_t bx, const void * GGML_RESTRICT y, size_t by, int nrc);
GGML_API void vec_dot_q5_K_q8_K_generic  (int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT x, size_t bx, const void * GGML_RESTRICT y, size_t by, int nrc);
GGML_API void vec_dot_mxfp4_q8_0_generic (int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT x, size_t bx, const void * GGML_RESTRICT y, size_t by, int nrc);
GGML_API void vec_dot_mxfp4_q8_0_hvx    (int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT x, size_t bx, const void * GGML_RESTRICT y, size_t by, int nrc);
GGML_API void vec_dot_nvfp4_q8_0_generic (int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT x, size_t bx, const void * GGML_RESTRICT y, size_t by, int nrc);
GGML_API void vec_dot_iq4_xs_q8_K_generic(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT x, size_t bx, const void * GGML_RESTRICT y, size_t by, int nrc);
GGML_API void vec_dot_iq3_xxs_q8_K_generic(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT x, size_t bx, const void * GGML_RESTRICT y, size_t by, int nrc);
GGML_API void vec_dot_iq2_xxs_q8_K_generic(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT x, size_t bx, const void * GGML_RESTRICT y, size_t by, int nrc);
...
GGML_API void quantize_row_q5_0_hvx          (const float * GGML_RESTRICT x, block_q5_0 * GGML_RESTRICT y, int n);
GGML_API void quantize_row_q5_1_hvx          (const float * GGML_RESTRICT x, block_q5_1 * GGML_RESTRICT y, int n);
